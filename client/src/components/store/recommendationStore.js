...
const generateMockRecommendations = (preferences) => {
    const destinations = [
        {
            ...
            attractions: ['Sacred Monkey Forest', 'Ubud'],
            matchScore: 95
        },
        {
            id: '2',
            name: 'Kyoto, Japan',
            description: 'Ancient Japanese city...',
            ...
            attractions: ['Fushimi Inari Shrine', 'Arashiyama'],
            matchScore: 90
        },
        {
            id: '3',
            name: 'Barcelona, Spain',
            description: 'Vibrant city with...',
            ...
            rating: 4.7,
            reviewCount: 1578,
            interests: ['city', 'culture', 'beach', 'food'],
            activities: ['sightseeing', 'museums', 'swimming', 'nightlife'],
            budget: 'medium',
            bestSeason: 'summer',
            travelDuration: '4-6 days',
    ...
    return destinations
        .map(destination => {
            ...
            (preferences.interests.interests).forEach(interest => {
